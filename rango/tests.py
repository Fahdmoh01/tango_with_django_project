...
#Now let's check the index view when categories are present. We can add a helper function for us to achieve this. This
#simple function doesn't live within a class we - just place it in the test.py module.
